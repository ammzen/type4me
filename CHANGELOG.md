...
## v2.1.0 — 设置重构、Intelli Sense、统一翻译与语音改口 (2026-08-18)

v2.1.0 全面刷新了设置与录音交互体验，新增上下文感知写作、持久化语音问答、多语言翻译与语音改口能力。

### 主要亮点 (Highlights)
- **全新设置与录音交互**：重构首页、模式、历史、词汇和模型设置，提供更清晰的录音与处理状态反馈
- **多快捷键支持**：同一模式可绑定多个「按住说话 (hold)」或「按一下开始/按一下停止 (toggle)」快捷键；录音期间可直接按下目标模式快捷键切换处理方式
- **Intelli Sense（可选）**：结合当前 App、输入控件与有限上下文进行安全润色；可独立开启并学习稳定的纠错、表达与列表结构偏好（各项感知与学习默认保持关闭）
...
### 改进 (Improvements)
- **最终文本格式化**：可选盘古中英文空格与中文直角引号转换，同时保留英文撇号
